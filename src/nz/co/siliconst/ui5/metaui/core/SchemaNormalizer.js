...
var SchemaNormalizer = /** @class */ (function () {
     ...
     */
    SchemaNormalizer.prototype.canHandle = function (rawSchema) {
     ...
     * ISchemaBuilderPlugin Contract
     */
    SchemaNormalizer.prototype.build = function (rawSchema, targetDefinition) {
    ...
    SchemaNormalizer.normalize = function (rawSchema, data) {
        ...
        try {
            ...
            if (normalized.type === "object") {
                var requiredKeys = Array.isArray(schemaObj.required) ? schemaObj.required : [];
     ...
     */
    SchemaNormalizer.normalizeProperties = function (properties, requiredKeys) {
        if (requiredKeys === void 0) { requiredKeys = []; }
        var normalizedProps = {};
        for (var _i = 0, _a = Object.keys(properties); _i < _a.length; _i++) {
            var key = _a[_i];
            var isRequired = requiredKeys.includes(key);
     ...
     */
    SchemaNormalizer.normalizePropertyMetadata = function (prop, keyName, isRequired) {
        ...
        var normalized = {
            ...
            ui: {
                ...
                dialogButtonText: (_o = prop.ui) === null || _o === void 0 ? void 0 : _o.dialogButtonText
            },
        ...
        if (normalized.type === "object" && prop.properties) {
            var requiredKeys = Array.isArray(prop.required) ? prop.required : [];
            normalized.properties = this.normalizeProperties(prop.properties, requiredKeys);
            normalized.uiLayout = prop.uiLayout;
        }
        else if (normalized.type === "array" && prop.items) {
            normalized.items = this.normalizePropertyMetadata(prop.items, "items", false);
            normalized.uiLayout = prop.uiLayout;
        }
        return normalized;
    };
